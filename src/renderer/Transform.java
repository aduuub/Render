...
public class Transform {
	...
	/** Construct an identity Transformation */
	public static Transform initital() {
		return new Transform(new float[][] { { 1.0f, 1.0f, 1.0f, 1.0f },
	...
	/**
	 * Transforms a float[3][4] into vectors
	 * @param points
	 * @return
	 */
	public static Vector3D[] convertToVectors(float[][] points){
		if (points.length != 3 || points[0].length != 4)
			throw new IllegalArgumentException(
					"Transform: Wrong size array for argument: " + points);
