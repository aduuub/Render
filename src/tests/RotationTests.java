...
public class RotationTests {
	...
	public void testNoRotation() {
		...
		Scene scene = new Scene(polys, light);
	...
	public void testXZRotation() {
		float[] verts = new float[] { 10, 5, 5, 2, 3, 2, 9, 5, 4 };
		//float[] verts = new float[] { 10, 10, 10, 10, 10, 10, 10, 10, 10};
		...
		System.out.println("\n EXPECTED: \n");
		for(float f : vertsExpected)
			System.out.println(f);
		
		System.out.println("\n ACTUAL: \n");
		
	Vector3D[] actualVerts = p2.getVertices();
	for(Vector3D v : actualVerts){
